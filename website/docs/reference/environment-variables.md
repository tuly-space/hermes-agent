...
| `HERMES_DASHBOARD_OIDC_ALLOWED_EMAILS` | Optional comma-separated email allowlist. When set, login requires an exact case-insensitive match and a verified OIDC email claim. Overrides `dashboard.oauth.self_hosted.allowed_emails`. |
